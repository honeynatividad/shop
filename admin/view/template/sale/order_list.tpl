        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <button type="button" id="report-download" class="btn btn-primary"><?php echo $button_download ?></button>
            </div>
          </div>
        </div>
...
$('#button-download').on('click', function() {
  url = 'index.php?route=sale/download/export&token=<?php echo $token; ?>';
...
<script type="text/javascript"><!--
  $('#report-download').on('click', function() {
    url = 'index.php?route=report/download/export&token=<?php echo $token; ?>';
    var filter_order_status = $('select[name=\'filter_order_status\']').val();
