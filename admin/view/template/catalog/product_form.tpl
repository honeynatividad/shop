          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea name="custom_desc" rows="5" placeholder="<?php echo $entry_custom_desc; ?>" class="form-control"><?php echo $custom_desc; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-product_type">
                  <span data-toggle="tooltip" title="<?php echo $help_product_type; ?>"><?php echo $entry_product_type; ?></span>
                </label>
                <div class="col-sm-10">
                  <textarea name="product_type" rows="5" placeholder="<?php echo $entry_product_type; ?>" class="form-control"><?php echo $product_type; ?></textarea>
                </div>
              </div>
