<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <!-- edited by HCN aug 2017 !-->
      <li><a href="<?php echo $vendor; ?>"><?php echo $text_vendor; ?></a></li>
      <li><a href="<?php echo $vendor_product; ?>"><?php echo $text_vendor_product; ?></a></li>
    </ul>
  </li>
  ...
  <li id="sale"><a class="parent"><i class="fa fa-shopping-cart fa-fw"></i> <span><?php echo $text_sale; ?></span></a>
    <ul>
      ...
      <!-- edited by HCN aug 2017 !-->
      <li><a href="<?php echo $order_repurchase; ?>"><?php echo $text_repurchase; ?></a></li>
      <!-- end of edit !-->
