...
class ControllerCatalogBossRefinesearchSetting extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/boss_refinesearch_setting', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/boss_refinesearch_setting', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('catalog/boss_refinesearch_setting/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/boss_refinesearch_setting/delete', 'token=' . $this->session->data['token'] . $url, true);
		$data['add_link'] =  $this->url->link('catalog/boss_refinesearch_setting', 'token=' . $this->session->data['token'], true);
		$data['setting_link'] =  $this->url->link('module/boss_refinesearch', 'token=' . $this->session->data['token'], true);
		...
		foreach ($results as $result) {
			$data['filters'][] = array(
				...
				'edit'            => $this->url->link('catalog/boss_refinesearch_setting/edit', 'token=' . $this->session->data['token'] . '&filter_group_id=' . $result['filter_group_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('catalog/boss_refinesearch_setting', 'token=' . $this->session->data['token'] . '&sort=fgd.name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('catalog/boss_refinesearch_setting', 'token=' . $this->session->data['token'] . '&sort=fg.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('catalog/boss_refinesearch_setting', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['filter_group_id'])) {
			$data['action'] = $this->url->link('catalog/boss_refinesearch_setting/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/boss_refinesearch_setting/edit', 'token=' . $this->session->data['token'] . '&filter_group_id=' . $this->request->get['filter_group_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/boss_refinesearch_setting', 'token=' . $this->session->data['token'] . $url, true);
