  ...
  <div class="product-info">
    ...
    <?php if ($thumb || $images) { ?>
        <div class="<?php echo $class; ?> ">
          ...
          <ul class="thumbnails">
            <?php if ($thumb) { ?>
            <li><a class="thumbnail" href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>"><img src="../testsite/image/<?php echo $madanes_image; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a></li>
            <?php } ?>
      </ul>
