    ...
    <div class="row">
        <div id="logo" class="col-sm-12">
			...
			<!-- <div class="w3-content w3-display-container" style="max-width:800px">
			  <img class="mySlides img-responsive" src="../testsite/image/catalog/voucher/madanes_banner.jpg" style="width:100%">
			  <img class="mySlides img-responsive" src="../testsite/image/catalog/voucher/madanes_banner2.jpg" style="width:100%">
			  <img class="mySlides img-responsive" src="../testsite/image/catalog/voucher/madanes_banner3.jpg" style="width:100%">
