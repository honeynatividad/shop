...
echo '<div style="text-align:right;"><a href="http://www.ipay88.com" target="New"><img src="image/catalog/philcare/logo-ipay88.png" alt="iPay88" title="iPay88" style="border: 1px solid #EEEEEE;" /></a></div>';
