...
//==============================
// Get Information from PhilCare if CertNo was given
//==============================

//$certno = $this->session->data['certno'];
if(!empty($certno)){
  $url_link = "https://apps.philcare.com.ph/PCareMicrositeTest/Members.svc/MembersInfo/?CertNo=".$certno;
  ...
  if(!$getxml){
      ...
      $email = $info->Email;
      $telephone = $info->ContactNumber;
      $company = $info->AgreementName;
...
<div class="row">
  <div class="col-sm-12">
    <fieldset id="account">
      ...
      <div class="form-group required">
        <!-- <img src="../testsite/image/catalog/logo/facebook-login.png" height="20%">
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-firstname"><?php echo $entry_firstname; ?><span style="color:red">*</span></label>
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-lastname"><?php echo $entry_lastname; ?><span style="color:red">*</span></label>
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-email"><?php echo $entry_email; ?><span style="color:red">*</span></label>
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-telephone"><?php echo $entry_telephone; ?><span style="color:red">*</span></label>
      ...
      <div class="form-group">
        <label class="control-label" for="input-entry-first-time"><?php echo $entry_first_time; ?></label>
      </div>
      <div class="radio">
        <label>        
          <input type="radio" name="first_time" value="Yes" checked="checked" />Yes
        </label>
      </div>
      <div class="radio">
        <label>        
  ...
  <!-- <div class="col-sm-6">
    <fieldset id="address">
      ...
      <input type="hidden" name="company" value="<?php echo $company; ?>" placeholder="<?php echo $entry_company; ?>" id="input-payment-company" class="form-control" />
      
      <div class="form-group required">
        <label class="control-label" for="input-payment-address-1"><?php echo $entry_address_1; ?><span style="color:red">*</span></label>
      ...
      <div class="form-group">
        <label class="control-label" for="input-payment-address-2"><?php echo $entry_address_2; ?><span style="color:red">*</span></label>
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-city"><?php echo $entry_city; ?><span style="color:red">*</span></label>
        <input type="text" name="city" value="<?php echo $city; ?>" placeholder="<?php echo $entry_city; ?>" id="input-payment-city" class="form-control" />
      </div>
      <div class="form-group required">
        <label class="control-label" for="input-payment-postcode"><?php echo $entry_postcode; ?><span style="color:red">*</span></label>
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-country"><?php echo $entry_country; ?><span style="color:red">*</span></label>
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-zone"><?php echo $entry_zone; ?><span style="color:red">*</span></label>
