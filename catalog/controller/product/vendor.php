...
class ControllerProductVendor extends Controller {
	...
	public function view(){		
    	...
    	if (isset($this->request->get['_route_'])) {
        	...
        	if (isset($this->request->get['name'])) {
				$name = $this->request->get['name'];
				/*if($name == "Madanes"){
					$name = "288F76EF-0081-49B4-BA87-7C017ACD8DEB";
				}*/
	...
	public function madanes_computation(){
		...
		$vendor_id = 3;
		$vendor_code = $this->session->data['vendor_code'];
		...
		if ($product_info) {
			...
			$m ="btadd.madanescart('0','".$vendor_id."', '".$product_info['product_id']."', '".$quantity."','".$vendor_code."');";
			$string = '
        ...
        <button class="btn-compare" type="button" title="COMPARE THIS PRODUCT" onclick="btadd.compare("'.$product_info['product_id'].'");"><i class="fa fa-retweet"></i> </button>
			...
			$s = '<div class="product-info button-group2">
        <button type="button" id="button-cart" data-loading-text="loading" class="btn-cart" onclick="'.$m.'"><i class="fa fa-shopping-cart"></i>QUICK CHECK OUT</button>
	...
	public function view_madanes(){		
    	...
    	$redirect = 0; //if 0, it means it will not redirect to erro
    	if (isset($this->request->get['_route_'])) {
        	$name = $this->request->get['_route_'];
        }else{
        	if (isset($this->request->get['name'])) {
