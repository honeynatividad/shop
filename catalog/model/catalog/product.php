...
class ModelCatalogProduct extends Model {
	...
	public function getProducts($data = array()) {
		...
		$sql .=" AND p.product_type !='BFCA1' AND p.product_type !='BFCA2' AND p.product_type !='BFCK' AND p.product_type != 'BFCWA1' AND p.product_type != 'BFCWA2' AND p.product_type !='BFCWK'";
