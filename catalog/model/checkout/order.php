...
class ModelCheckoutOrder extends Model {
	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false, $override = false) {
		...
		//echo '<pre>';
		//	print_r("FROM DB START == ".$order_status_id);
		//	echo '</pre>';
		if ($order_info) {
			// Fraud Detection
			...
			// If order status is not 0 then send update text email
				//echo '<pre>';
				//echo $order_info['order_status_id'] ." - ". $order_status_id ." = ". $notify;
				//echo '</pre>';
	...
	// This is to send transaction to OneSystem
	public function sendAPI($data){
		//$data
		$url = "https://apps.philcare.com.ph/IPhilCareWSTest/Ecommerce.svc/SaveEcommerceTran/?InvoiceNo=123123&FirstName=Jed%20Sebastian&LastName=Jed&MiddleName=Delgado&Email=jromasanta@philcare&TelNo=12122&CompanyName=asdada&Adr1=dasd&Adr2=dasasd&Adr3=adad&City=sadasd&Country=PH&PostalCode=4009&Shipping=fsdfsdf&Total=100&OrderStatus=asdada&PaymentMethod=cash";
	}
}